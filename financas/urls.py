...
from financas.views.views import FinancasFindByIdView, FinancasCreateView, FinancasDeleteView, FinancasFindyByNotionIdView, FinancasListNotionView, FinancasListView, FinancasUpdateView
...
urlpatterns = [
    ...
    path('financas/listnotion/', FinancasListNotionView.as_view(), name='Listar todas as Finanças do Notion'),
